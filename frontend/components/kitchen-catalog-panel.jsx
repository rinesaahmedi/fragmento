...
const ICON_MARKUP = {
  ...
  hood_wall_cabinet:
    '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60 82" fill="none" stroke="currentColor" stroke-width="1"><rect x="0.5" y="0.5" width="59" height="59"/><line x1="20" y1="50" x2="40" y2="50" stroke-linecap="round" stroke-width="1.5"/><rect x="8" y="60.5" width="44" height="5"/><line x1="8" y1="65.5" x2="52" y2="65.5"/><g stroke="#666" stroke-width="0.75"><line x1="20" y1="70" x2="17" y2="79"/><line x1="30" y1="70" x2="30" y2="80"/><line x1="40" y1="70" x2="43" y2="79"/></g></svg>',
    ...
    >
      <div className={styles.itemTop}>
        ...
        <div className={styles.itemText}>
          ...
          {item.blendeLabel ? <span className={styles.itemBlendeNote}>+ {item.blendeLabel}</span> : null}
