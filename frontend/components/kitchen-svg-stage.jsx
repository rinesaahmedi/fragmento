...
const IMAGE_HOTSPOTS_BY_SLUG = {
  ...
  "ab-105808": [
    { componentKey: "refrigerator", left: 1.25, top: 28.06, width: 16.36, height: 59.52 },
    ...
    { componentKey: "drawer-module", left: 81.23, top: 58.81, width: 14.12, height: 29.25 },
  ],
  "ab-105810": [
    { componentKey: "refrigerator", left: 3.89, top: 28.25, width: 12.97, height: 59.11 },
    ...
    { componentKey: "base-module-1", left: 18.12, top: 58.35, width: 10.51, height: 29.01 },
    { componentKey: "oven-module", left: 28.63, top: 58.35, width: 14.02, height: 29.01 },
    { componentKey: "base-module-2", left: 42.65, top: 58.35, width: 9.34, height: 29.01 },
    { componentKey: "base-module-3", left: 51.99, top: 58.35, width: 14.01, height: 29.01 },
    { componentKey: "sink-base", left: 66, top: 58.35, width: 14.01, height: 29.01 },
    { componentKey: "drawer-module", left: 80.01, top: 58.35, width: 14.01, height: 29.01 },
  ],
  "ab-105812": [
  ...
  "ab-105814": [
    { componentKey: "refrigerator", left: 2.86, top: 28.85, width: 13.26, height: 60.32 },
    ...
    { componentKey: "base-module-1", left: 17.51, top: 59.54, width: 10.73, height: 29.63 },
    { componentKey: "oven-module", left: 28.24, top: 59.54, width: 14.32, height: 29.63 },
    { componentKey: "base-module-2", left: 42.56, top: 59.54, width: 9.53, height: 29.63 },
    { componentKey: "base-module-3", left: 52.09, top: 59.54, width: 14.31, height: 29.63 },
    { componentKey: "sink-base", left: 66.4, top: 59.54, width: 14.31, height: 29.63 },
    { componentKey: "drawer-module", left: 80.71, top: 59.54, width: 14.3, height: 29.63 },
  ],
  "ab-105819": [
