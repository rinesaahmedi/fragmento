...
const IMAGE_VIEW_BY_SLUG = {
  ...
  "ab-105814": "/plans/AB%20105810.svg",
...
const IMAGE_HOTSPOTS_BY_SLUG = {
  ...
  "ab-105810": [
    ...
    { componentKey: "wall-cabinet-6", left: 80.01, top: 15.77, width: 15, height: 23.91 },
    { componentKey: "worktop", left: 18.12, top: 57.02, width: 76.7, height: 1.35 },
    ...
    { componentKey: "drawer-module", left: 80.01, top: 56.98, width: 15, height: 30.38 },
  ],
  "ab-105812": [
  ...
  "ab-105814": [
    ...
    { componentKey: "wall-cabinet-5", left: 66, top: 15.77, width: 14.01, height: 23.91 },
    { componentKey: "wall-cabinet-6", left: 80.01, top: 15.77, width: 15, height: 23.91 },
    { componentKey: "worktop", left: 18.12, top: 57.02, width: 76.89, height: 1.35 },
    { componentKey: "worktop", left: 17.67, top: 56.98, width: 0.45, height: 30.38 },
    { componentKey: "sink-faucet", left: 67.65, top: 50.15, width: 4.35, height: 8 },
    { componentKey: "base-module-1", left: 18.12, top: 56.98, width: 10.51, height: 30.38 },
    { componentKey: "oven-module", left: 28.63, top: 56.98, width: 14.02, height: 30.38 },
  ...
  "ab-105816": [
    ...
    { componentKey: "wall-cabinet-6", left: 81.23, top: 15.97, width: 15.07, height: 24.27 },
    { componentKey: "worktop", left: 17.17, top: 57.9, width: 79.13, height: 1.35 },
    ...
    { componentKey: "drawer-module", left: 81.23, top: 57.86, width: 15.07, height: 30.89 },
  ],
  "ab-105819": [
    ...
    { componentKey: "worktop", left: 2.8, top: 63.47, width: 63.56, height: 1.35 },
  ...
  "ab-105821": [
    { componentKey: "wall-cabinet-1", left: 9.95, top: 16.49, width: 13.48, height: 24.32 },
    ...
    { componentKey: "worktop", left: 9.95, top: 58.47, width: 63.38, height: 1.35 },
    ...
    { componentKey: "base-module-1", left: 9.95, top: 58.49, width: 13.48, height: 25.66 },
...
IMAGE_HOTSPOTS_BY_SLUG["ab-105818"] = IMAGE_HOTSPOTS_BY_SLUG["ab-105814"];
