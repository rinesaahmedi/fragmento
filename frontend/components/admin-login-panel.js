...
const checklistKeys = [
  ["adminShellLogin.updateKitchenSlugsVisibilityAndDescriptions", "Update kitchen slugs, visibility, and descriptions."],
  ["adminShellLogin.maintainComponentsAccessoriesAndServicePricing", "Maintain components, accessories, and service pricing."],
  ["adminShellLogin.reviewIncomingOrdersAndOperationalStatusQuickly", "Review incoming orders and operational status quickly."],
];
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: 16 }}>
            <div style={{ display: "grid", gap: 12 }}>
              ...
              <h1 style={{ margin: 0, fontSize: "clamp(1.9rem, 2.5vw, 3rem)", lineHeight: 1.03, maxWidth: 420 }}>
                <AdminText i18nKey="adminShellLogin.manageKitchensCatalogAndOrders" fallback="Manage kitchens, catalog, and orders." />
              </h1>
              <p style={{ margin: 0, color: "rgba(255,247,239,0.78)", fontSize: "0.98rem", maxWidth: 420, lineHeight: 1.65 }}>
                <AdminText i18nKey="adminShellLogin.panelControlsLiveKitchenConfigurator" fallback="This panel controls the live kitchen configurator. Keep catalog data, pricing, and order handling aligned from one place." />
              </p>
            </div>
            <div style={{ "--app-text-muted": "#f9dfc1", "--app-text": "#fff7ef", "--app-border-strong": "rgba(255,255,255,0.22)" }}>
              <AdminLanguageSwitcher />
            </div>
          </div>

          <div style={{ display: "grid", gap: 14 }}>
            {checklistKeys.map(([i18nKey, fallback]) => (
              <div
                key={i18nKey}
                style={{
                  display: "flex",
              ...
              >
                ...
                <span style={{ lineHeight: 1.5 }}>
                  <AdminText i18nKey={i18nKey} fallback={fallback} />
                </span>
              </div>
            ))}
          </div>
        ...
        >
          <div style={{ display: "grid", gap: 8 }}>
            ...
            <p style={{ margin: 0, color: "#6d655c", lineHeight: 1.6, fontSize: "1.05rem", maxWidth: 460 }}>
              <AdminText i18nKey="adminShellLogin.signInWithAdminCredentialsConfiguredInEnvironment" fallback="Sign in with the admin credentials configured in your environment." />
            </p>
          </div>
