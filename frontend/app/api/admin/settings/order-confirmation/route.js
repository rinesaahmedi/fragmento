...
import { setDirectOrderConfirmationEnabled } from "../../../../../lib/admin-settings";
...
export async function POST(request) {
  try {
    ...
    const enabled = formData.has("directOrderConfirmationEnabled");

    await setDirectOrderConfirmationEnabled(enabled);
