...
const CATALOG_ARTICLES = [
  ...
  { articleNumber: "H4502", name: "Upper cabinet 45 cm", nameDe: "Oberschrank 45 cm", widthMm: 450, heightMm: 720, depthMm: 340, price: "139.00", itemType: ItemType.COMPONENT },
  { articleNumber: "H5002", name: "Upper cabinet 50 cm", nameDe: "Oberschrank 50 cm", widthMm: 500, heightMm: 720, depthMm: 340, price: "135.00", itemType: ItemType.COMPONENT },
  { articleNumber: "H6002", name: "Upper cabinet 60 cm", nameDe: "Oberschrank 60 cm", widthMm: 600, heightMm: 720, depthMm: 340, price: "149.00", itemType: ItemType.COMPONENT },
  ...
  { articleNumber: "US2A60", name: "Lower Cabinet with Drawer/Soft-close 60", nameDe: "Unterschrank mit Auszügen 60 cm", widthMm: 600, heightMm: 720, depthMm: 600, price: "369.00", itemType: ItemType.COMPONENT },
  ...
  { articleNumber: "US50", name: "Lower cabinet with drawer 50 cm", nameDe: "Unterschrank mit Schublade 50 cm", widthMm: 500, heightMm: 720, depthMm: 600, price: "198.00", itemType: ItemType.COMPONENT },
  { articleNumber: "US60", name: "Lower cabinet with drawer 60 cm", nameDe: "Unterschrank mit Schublade 60 cm", widthMm: 600, heightMm: 720, depthMm: 600, price: "219.00", itemType: ItemType.COMPONENT },
  { articleNumber: "US80", name: "Lower cabinet with drawer 80 cm", nameDe: "Unterschrank mit Schublade 80 cm", widthMm: 800, heightMm: 720, depthMm: 600, price: "333.00", itemType: ItemType.COMPONENT },
  { articleNumber: "US90", name: "Lower cabinet with drawer 90 cm", nameDe: "Unterschrank mit Schublade 90 cm", widthMm: 900, heightMm: 720, depthMm: 600, price: "339.00", itemType: ItemType.COMPONENT },
  { articleNumber: "US100", name: "Lower cabinet with drawer 100 cm", nameDe: "Unterschrank mit Schublade 100 cm", widthMm: 1000, heightMm: 720, depthMm: 600, price: "353.00", itemType: ItemType.COMPONENT },
  { articleNumber: "US120", name: "Lower cabinet with drawer 120 cm", nameDe: "Unterschrank mit Schublade 120 cm", widthMm: 1200, heightMm: 720, depthMm: 600, price: "403.00", itemType: ItemType.COMPONENT },
