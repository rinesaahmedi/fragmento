...
export function serializeKitchenForLegacy(kitchen) {
  ...
  return {
    kitchen: {
      ...
      hotspots: Array.isArray(kitchen.hotspots) ? kitchen.hotspots : [],
      linkedComponentGroups: Array.isArray(kitchen.linkedComponentGroups) ? kitchen.linkedComponentGroups : [],
    },
