...
export const MONTAGE_REQUIRED_CODES = [
  ...
  "model-c-cook-base-left",
  "model-c-oven-base",
  "model-c-cook-base-right",
  "model-c-wall-cabinet-1",
  "model-c-wall-cabinet-2",
  "model-c-wall-cabinet-3",
  "model-c-wall-cabinet-4",
  "model-c-wm-base",
  "model-c-sink-base",
  "model-c-dishwasher-base",
  "model-c-drawer-base-3",
];
