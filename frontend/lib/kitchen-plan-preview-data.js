...
export const PLAN_HOTSPOTS_BY_SLUG = {
  ...
  "ab-105805": [
    ...
    },
    {
      ...
      points: [[57.55, 49.45], [62.82, 54.28], [62.82, 78.35], [57.55, 73.45]],
    },
    {
    ...
    },
    {
      ...
      points: [[70.15, 59.65], [73.0, 61.38], [73.0, 86.53], [70.15, 84.75]],
    },
    {
      componentKey: "sink-base",
    ...
    {
      componentKey: "base-module-2",
      points: [[56.35, 49.2], [57.6, 49.95], [57.6, 73.55], [56.35, 72.85]],
      preserveManualSize: true,
    },
    // End blende left of the return-leg sink cabinet — belongs to the dishwasher, not sink-base.
    {
      componentKey: "base-module-3",
      points: [[69.1, 59.35], [70.2, 59.95], [70.2, 84.65], [69.1, 84.1]],
      preserveManualSize: true,
    },
    // Left fridge-end worktop blende (locked with worktop).
    {
      componentKey: "worktop",
      points: [[27.62, 48.8], [28.82, 49.75], [28.72, 82.1], [27.62, 82.3]],
      preserveManualSize: true,
    },
    {
  ...
  "ab-104968": [
    ...
    { componentKey: "extractor-hood", points: [[20.92, 38.84], [16.02, 39.51], [20.92, 40.57], [20.92, 14.72], [15.83, 13.79], [26.76, 12.19], [31.84, 13.25], [31.75, 38.97]], preserveManualSize: true },
    { componentKey: "extractor-hood", points: [[20.92, 38.84], [31.75, 38.97], [31.75, 41.05], [29.64, 41.33], [28.5, 44.35], [27.64, 41.45], [24.22, 41.94], [23.23, 44.35], [22.51, 41.85], [20.92, 42.14]], preserveManualSize: true },
