...
export async function prepareKitchenItemMutation({ formData, kitchen, excludeItemId = "", existingItem = null }) {
  ...
  const data = {
    ...
    price: standaloneCatalogBlende
      ? String(catalogBlendePrice)
      : applyBlendePriceDelta(input, existingItem, catalogBlende, catalogBlendePrice),
    ...
    blendePrice: standaloneCatalogBlende ? null : catalogBlendePrice,
