...
test("AB 105831 email uses the dashboard sink and faucet geometry", () => {
  ...
  assert.deepEqual(faucets[1].points, [
    [25.05, 58.3], [25.05, 52.0], [25.1, 51.1], [25.4, 50.3],
    [26.0, 49.7], [26.7, 49.35], [29.0, 48.4], [29.05, 47.6],
    [29.7, 47.65], [29.55, 51.2], [28.95, 51.1], [29.0, 50.6],
    [26.9, 49.9], [26.2, 50.1], [25.7, 50.5], [25.45, 51.0],
    [25.35, 51.7], [25.35, 58.3],
  ]);
});
