...
const L_SHAPED_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "SINKBASE-LS-600", name: "SP60L Sink Base Cabinet (600 x 723 mm)", price: "0.00", iconKey: "sink_base", colorKey: "springgreen", componentKey: "base-module-3", sortOrder: 120, isLocked: true, infoText: "SP60L, 1 door, fixed inner front panel", articleNumber: "SP60L" },
