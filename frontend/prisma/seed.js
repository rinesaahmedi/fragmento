...
const MODEL_B_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "model-b-wall-cabinet-4", name: "Wall Cabinet mid-right", price: "115.00", iconKey: "wall_cabinet_plain", colorKey: "#394c00", componentKey: "wall-cabinet-4", sortOrder: 40 },
  ...
  { itemType: ItemType.COMPONENT, code: "model-b-extractor-hood", name: "Extractor Hood flat", price: "349.00", iconKey: "extractor_hood", colorKey: "#394c00", componentKey: "extractor-hood", sortOrder: 52, infoText: "Flat extractor hood" },
  ...
  { itemType: ItemType.COMPONENT, code: "model-b-worktop", name: "Worktop", price: "0.00", iconKey: "worktop", colorKey: "springgreen", componentKey: "worktop", sortOrder: 85, isLocked: true },
  { itemType: ItemType.COMPONENT, code: "model-b-oven-module", name: "Oven Base Unit", price: "449.00", iconKey: "oven_base", colorKey: "springgreen", componentKey: "oven-module", sortOrder: 90, infoText: "Backofen mit Unterbau", isLocked: true },
  ...
  { itemType: ItemType.COMPONENT, code: "model-b-sink-faucet", name: "Sink Faucet", price: "0.00", iconKey: "sink_faucet", colorKey: "black", componentKey: "sink-faucet", sortOrder: 120, isLocked: true },
...
const MODEL_C_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "model-c-oven-base", name: "Oven Base Unit", price: "449.00", iconKey: "oven_base", colorKey: "#00c76a", componentKey: "oven-base", sortOrder: 40, infoText: "Central cooking unit", isLocked: true },
  ...
  { itemType: ItemType.COMPONENT, code: "model-c-sink-base", name: "Sink Base Cabinet", price: "249.00", iconKey: "sink_base", colorKey: "springgreen", componentKey: "sink-base", sortOrder: 120, isLocked: true },
  ...
  { itemType: ItemType.COMPONENT, code: "model-c-worktop", name: "Worktop", price: "0.00", iconKey: "worktop", colorKey: "springgreen", componentKey: "worktop", sortOrder: 135, isLocked: true },
  ...
  { itemType: ItemType.COMPONENT, code: "model-c-sink-faucet", name: "Sink Faucet Accessory", price: "0.00", iconKey: "sink_faucet", colorKey: "black", componentKey: "sink-faucet", sortOrder: 150, isLocked: true },
  { itemType: ItemType.ACCESSORY, code: "acc-waste", name: "Mülltrennsystem", price: "89.00", iconKey: "waste_system", sortOrder: 200 },
  { itemType: ItemType.ACCESSORY, code: "acc-cutlery", name: "Besteckeinsatz 30cm", price: "19.00", iconKey: "cutlery_insert", sortOrder: 210 },
  { itemType: ItemType.ACCESSORY, code: "acc-lighting", name: "Beleuchtungsset 3 LED-Spots", price: "69.00", iconKey: "lighting_set", sortOrder: 220 },
  { itemType: ItemType.SERVICE, code: "service-montage", name: "Lieferung, Vertragen, Montage und Anschluss", price: "349.00", iconKey: "delivery_assembly", sortOrder: 300 },
