...
const AB_105809_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "SINKBASE-AB105809-US30", name: "Sink Base Cabinet", price: "0.00", widthMm: 300, depthMm: 600, iconKey: "drawer_base_two", colorKey: "springgreen", componentKey: "corner-base", sortOrder: 60, isLocked: true, infoText: "US30 sink base cabinet, hinge left", articleNumber: "US30" },
...
const AB_105805_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "DISH-AB105806-600", name: "Dishwasher", price: "579.00", iconKey: "dishwasher_base", colorKey: "#001f7f", componentKey: "base-module-3", sortOrder: 50, infoText: "Fully integrated dishwasher, 60 cm", articleNumber: "A-EGSPV597210 + TGV60" },
  { itemType: ItemType.COMPONENT, code: "SINKBASE-AB105805-US30-L", name: "Sink Base Cabinet", price: "200.00", widthMm: 300, depthMm: 600, iconKey: "sink_base", colorKey: "springgreen", componentKey: "corner-base", sortOrder: 60, isLocked: true, infoText: "US30 sink base cabinet, hinge left", articleNumber: "US30", blendeCode: "UPK20", blendeLabel: "UPK20 20 cm", blendePrice: "25.00" },
...
const AB_105834_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "SINKBASE-AB105806-600", name: "Sink Base Cabinet", price: "0.00", iconKey: "sink_base", colorKey: "springgreen", componentKey: "corner-base", sortOrder: 120, isLocked: true, infoText: "Blanco Botton Pro 45/2 waste system" },
...
const AB_105837_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "SINKBASE-AB105809-US30", name: "Sink Base Cabinet", price: "0.00", widthMm: 300, heightMm: 878, depthMm: 600, iconKey: "sink_base", colorKey: "springgreen", componentKey: "corner-base", sortOrder: 60, infoText: "US30 sink base cabinet, hinge left", articleNumber: "US30", isLocked: true },
...
const L_SHAPED_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "SINKBASE-LS-600", name: "Sink Base Cabinet", price: "175.00", widthMm: 300, heightMm: 720, depthMm: 600, iconKey: "drawer_base_two", colorKey: "springgreen", componentKey: "base-module-3", sortOrder: 120, isLocked: true, infoText: "US30, sink base cabinet", articleNumber: "US30" },
