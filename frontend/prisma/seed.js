...
const MODEL_B_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "CAB-HOOD-B-600", legacyCode: "model-b-wall-cabinet-4", name: "Hood Wall Cabinet (600 x 723 x 320 mm)", price: "139.00", iconKey: "wall_cabinet_plain", colorKey: "#394c00", componentKey: "wall-cabinet-4", sortOrder: 40, infoText: "HD6002, light hood setup" },
...
const L_SHAPED_ITEMS = [
  ...
  { itemType: ItemType.COMPONENT, code: "CORNER-LS-650", name: "UPEF65 Corner Filler (560 x 650 mm)", price: "0.00", iconKey: "base_cabinet_30", colorKey: "springgreen", componentKey: "corner-base", sortOrder: 110, isLocked: true, infoText: "Corner filler for base cabinets, 723 mm high, 90 degrees", articleNumber: "UPEF65" },
  ...
  { itemType: ItemType.COMPONENT, code: "DISH-LS-600-STD", name: "Dishwasher (600 x 600 x 878 mm)", price: "579.00", iconKey: "dishwasher_base", colorKey: "#001f7f", componentKey: "dishwasher-base", sortOrder: 130, infoText: "Fully integrated dishwasher, 60 cm", articleNumber: "A-EGSPV597210" },
