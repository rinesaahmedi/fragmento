UPDATE "KitchenItem"
SET "productInfoPdfPath" = '/product-info/khf-664-611-s-chimney-extractor-hood-product-info.pdf'
WHERE "code" = 'HOOD-C-FH664621E'
  AND "productInfoPdfPath" = '/product-info/extractor-hood-chimney-product-info.pdf';

UPDATE "KitchenItem"
SET "productInfoPdfPath" = '/product-info/ewa-34660-w-product-info.pdf'
