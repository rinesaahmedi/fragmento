-- Burger 103898 uses the A-EH923640E oven with the existing 9EC744100C
-- ceramic cooktop. The locked default package remains hidden from orders.
...
-- ASC exposes the oven itself with the matching product-information PDF.
